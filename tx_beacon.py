...
#
# This file is part of pyhoperf.
#
# pyhoperf is free software: you can redistribute it and/or modify it under the terms of the GNU Affero General Public
# License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later
# version.
#
# pyhoperf is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied
...
#        self.write_payload([0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f])
        self.set_mode(MODE.TX)
        while True:
            sleep(1)
